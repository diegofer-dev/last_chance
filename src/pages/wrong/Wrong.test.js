...
test('renders the wrong text and the correct answer', () => {
    ...
    const { queryByText } = renderWithProviders(<Wrong/>, {
        preloadedState: {
    ...
    expect(queryByText(/WRONG/)).toBeInTheDocument();
    expect(queryByText(/B\. Norway/)).toBeInTheDocument();
